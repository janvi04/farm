    				...
    				<ul class="product-category">
						...
						@foreach ($categories as $category)
    					     <li><a href="/view_by_cat/{{$category->category_name}}" 
								class= "{{(request()->is('/view_by_cat/'.$category->category_name)?'active':'')}}">{{$category->category_name}}</a></li>
    					@endforeach
    				</ul>
    			</div>
    		</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"></span><span class="price-sale">Rs{{$product->product_price}}</span></p>
		    					</div>
	    					</div>
